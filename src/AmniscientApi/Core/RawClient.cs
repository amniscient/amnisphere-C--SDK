...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<AmniscientApi.Core.ApiResponse> MakeRequestAsync(
        AmniscientApi.Core.BaseRequest request,
    ...
    internal async Task<AmniscientApi.Core.ApiResponse> SendRequestAsync(
        AmniscientApi.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<AmniscientApi.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new AmniscientApi.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(AmniscientApi.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(AmniscientApi.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use AmniscientApi.Core.ApiResponse instead.")]
    internal record ApiResponse : AmniscientApi.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use AmniscientApi.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : AmniscientApi.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use AmniscientApi.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : AmniscientApi.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use AmniscientApi.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : AmniscientApi.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use AmniscientApi.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : AmniscientApi.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use AmniscientApi.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : AmniscientApi.Core.StreamRequest;
}
